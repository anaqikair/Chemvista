...
export const translations = {
  ms: {
    ...
    navTeacher: 'Papan Pendidik',
    navSettings: 'Tetapan',
    roleStudent: 'Pelajar',
    roleTeacher: 'Guru',
    roleGuest: 'Pelawat',
    selectRoleTitle: 'Log Masuk Sistem',
    selectRoleSub: 'Sila pilih peranan anda untuk mengakses portal pembelajaran atau pengurusan.',
    studentRoleDesc: 'Akses semua modul ikatan kimia, kuiz, dan simpan rekod kemajuan anda.',
    teacherRoleDesc: 'Akses Papan Pemuka Guru untuk pantau prestasi dan markah kelas.',
    continueAsGuest: 'Teruskan Sebagai Pelawat (Bebas Akses)',
  ...
  en: {
    ...
    roleTeacher: 'Teacher',
    roleGuest: 'Guest',
    selectRoleTitle: 'System Login',
    selectRoleSub: 'Please select your role to access the learning portal or class management.',
    studentRoleDesc: 'Access all bonding modules, quizzes, and sync your learning records.',
    teacherRoleDesc: 'Access Teacher Dashboard to monitor class performance and student scores.',
    continueAsGuest: 'Continue as Guest (Full Access)',
